...
public class BookDAOImpl implements BookDAO{
	...
	public boolean addBooks(BookDtls b) {
		...
		try
		{
			String sql= "insert into book_dtls(bookname,author,price,bookCategory,typeCategory,status,photo,email) values(?,?,?,?,?,?,?,?)";
	...
	public List<BookDtls> getAllBooks() {
		...
		try
		{
			...
			while(rs.next())
			{
				...
				b.setTypeCategory(rs.getString(6));
	...
	@Override
	public List<BookDtls> getcomicbook() {
		List<BookDtls> list=new ArrayList<BookDtls>();
		BookDtls b=null;
		try
		{
